...
Uint32 count_period = 0xFFFFFFFF;
Uint32 last_changed_count = 0;
...
/*
    if(state != hall_state){
        hall_state = state;
        if(sampling_count < last_changed_count){
            count_period = (0xFFFFFFFF - last_changed_count) + sampling_count;
        }else{
            count_period = sampling_count - last_changed_count;
        }
        last_changed_count = sampling_count;
    }*/
    hall_state = state;
    return state;
}
